...
public class EmailService {
    ...
    /**
     * Envía email de bienvenida a un nuevo usuario registrado
     * @param to Email del destinatario
     * @param userName Nombre de usuario
     * @return Fecha de envío
     */
    public Date sendWelcomeEmail(String to, String userName) {
        String html = "<!DOCTYPE html>" +
                ...
                "<p>Hola " + userName + ",</p>" +
                "<p>¡Gracias por registrarte en nuestro gimnasio! Estamos emocionados de tenerte como parte de nuestra comunidad.</p>" +
                "<p>Tu cuenta ha sido creada exitosamente y ya puedes comenzar a usar todos nuestros servicios.</p>" +
                "<p>¿Qué puedes hacer ahora?</p>" +
                "<ul>" +
                "<li>Crear y personalizar tus rutinas de entrenamiento</li>" +
                "<li>Seguir tu progreso y objetivos</li>" +
                "<li>Acceder a planes de nutrición personalizados</li>" +
                "</ul>" +
                "<div class=\"button__container\">" +
                "<a href=\"http://localhost:9395\" class=\"button\">Comenzar Ahora</a>" +
                "</div>" +
                "<p>Si tienes alguna pregunta, no dudes en contactarnos.</p>" +
                "<p>¡Nos vemos en el gimnasio!</p>" +
                "<p>El equipo de Gimnasio</p>" +
                "</div>" +
                "" +
                "<div class=\"footer\">" +
